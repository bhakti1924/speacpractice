 ...
 * @defgroup BSP_MCU_MODULE_STOP_S5D9 Module Start and Stop
 *
...
static const uint8_t g_bsp_module_stop[] =
{
    ...
    BSP_MSTP_REG(BSP_MSTPCRD) | BSP_MSTP_BIT(20) | BSP_MSTP_EXCEPTION, // SSP_IP_DAC=33,
    ...
    BSP_MSTP_REG(BSP_MSTPCRB) | BSP_MSTP_BIT(13) | BSP_MSTP_EXCEPTION, // SSP_IP_EPTPC=65,
...
#endif /* if defined(BSP_MCU_GROUP_S5D9) */


/** @} (end defgroup BSP_MCU_MODULE_STOP_S5D9) */
