 ...
 * @defgroup BSP_MCU_ROM_REGISTER_S5D9 ROM Registers
 *
...
BSP_DONT_REMOVE static const uint32_t g_bsp_rom_registers[] BSP_PLACE_IN_SECTION_V2(BSP_SECTION_ROM_REGISTERS) =
{
    ...
    ((uint32_t)BSP_CFG_ROM_REG_MPU_REGION0_START  & 0x00FFFFFCU),
    ((BSP_CFG_ROM_REG_MPU_REGION0_END   & 0x00FFFFFFU) | 0x00000003U),
...
{
    BSP_CFG_ID_CODE_LONG_1,         /* 0x0100A150 */
    BSP_CFG_ID_CODE_LONG_2,         /* 0x0100A154 */
    BSP_CFG_ID_CODE_LONG_3,         /* 0x0100A158 */
    BSP_CFG_ID_CODE_LONG_4          /* 0x0100A15C */
};

#endif


/** @} (end defgroup BSP_MCU_ROM_REGISTER_S5D9) */
