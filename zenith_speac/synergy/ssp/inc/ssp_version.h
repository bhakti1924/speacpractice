...
#define SSP_VERSION_STRING                  ("2.5.0")

/** Unique SSP version ID. */
#define SSP_VERSION_BUILD_STRING            ("Built with Renesas Synergy (TM) Software Package version 2.5.0+build.8fcf27fe021a0c09fcac0026ce12b5baf206e015")
